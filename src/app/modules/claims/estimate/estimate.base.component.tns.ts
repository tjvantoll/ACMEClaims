...
//
// You can write your custom code in the estimate.component.tns.ts file instead.
...
export abstract class EstimateViewBaseComponent extends CustomEventHandlers {
    public $config = {};
