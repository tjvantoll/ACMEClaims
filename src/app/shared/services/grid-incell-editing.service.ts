...
import { DataServiceInterface } from '@src/app/core/data/data-service.interface';

export class GridIncellEditingService {
    public dataChanges = new BehaviorSubject<ModelDataResult<any>>(null);
    private data: any[] = [];
    ...
    public read(state: State): void {
        ...
        return this.dataChanges.next(currentData);
    }
