...
export class KSMapbox {
    ...
    static interpolate(stringToInterpolate, params) {
        const names = Object.keys(params);
        const values = Object.values(params);

        return new Function(...names, `return \`${stringToInterpolate}\`;`)(...values);
    }

    private createMarker(item: any) {
        const title = KSMapbox.interpolate(this.config.marker.title, { item });
        const subtitle = KSMapbox.interpolate(this.config.marker.subtitle, { item });
        ...
        return {
          ...
          onCalloutTap: () => {
              ...
              const extras: ExtendedNavigationExtras = {
                  ...
                  queryParams: {
                      [`${this.dataService.typeName}Id`]: item._id
                  },
